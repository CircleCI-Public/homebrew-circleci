...
cask "circleci@next" do
  version "1.0.44561-pre"

  on_macos do
    on_intel do
      sha256 "a6d4034331a9ecce1e4b601496fded13e390a9cbd08b3832cd61852e86c0a4c9"
      url "https://github.com/CircleCI-Public/circleci-cli/releases/download/v#{version}/circleci-cli_#{version}_darwin_amd64.tar.gz"
    end
    on_arm do
      sha256 "0c44d149aac1d50364007ae62831425fe024e4bc49d789e2f69aec23fa9e9db7"
  ...
  on_linux do
    on_intel do
      sha256 "3cc479296494980be8ebebebf0407904d4e970d97b2c4de58ec468618631a335"
      url "https://github.com/CircleCI-Public/circleci-cli/releases/download/v#{version}/circleci-cli_#{version}_linux_amd64.tar.gz"
    end
    on_arm do
      sha256 "31745eed9a08238597b5d6f006525f91100b5c41cace04ac9c109028a4c4d9a7"
