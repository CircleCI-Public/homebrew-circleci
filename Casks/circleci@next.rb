...
cask "circleci@next" do
  version "1.0.46851-pre"

  on_macos do
    on_intel do
      sha256 "6f2b407762ab4f12c36ba797f0b3bb6e39063535836ec01d9059e0fc1a8d8519"
      url "https://github.com/CircleCI-Public/circleci-cli/releases/download/v#{version}/circleci-cli_#{version}_darwin_amd64.tar.gz"
    end
    on_arm do
      sha256 "dbd9a5df6355da9fd3a4de4c7c1c4875038fd0a09ac155b44d2341f992c82dbb"
  ...
  on_linux do
    on_intel do
      sha256 "56f62078c66cf7070c32b47a73c400cb832040d105653cc79d4c79c0f6b4cecf"
      url "https://github.com/CircleCI-Public/circleci-cli/releases/download/v#{version}/circleci-cli_#{version}_linux_amd64.tar.gz"
    end
    on_arm do
      sha256 "b7f9675b8dfd0693d7f99da41cb8e1bd4e3e0069173dfaa022a14a6c56e788c6"
