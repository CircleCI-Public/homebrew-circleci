...
cask "circleci@next" do
  version "1.0.43647-pre"

  on_macos do
    on_intel do
      sha256 "b5d2f27f43c74cd3f885b771697a32c22ab4c87aac8fe8ef9fcdcca3b9ed5c61"
      url "https://github.com/CircleCI-Public/circleci-cli/releases/download/v#{version}/circleci-cli_#{version}_darwin_amd64.tar.gz"
    end
    on_arm do
      sha256 "3a47eb1a203782614842db62337f48d4eaa7702fadaab557602ab6a8ccbf4052"
  ...
  on_linux do
    on_intel do
      sha256 "3b42f37f4833d96ea6cbeb86fe96376b9ef766fbb664ce4c2f92693f00445ea9"
      url "https://github.com/CircleCI-Public/circleci-cli/releases/download/v#{version}/circleci-cli_#{version}_linux_amd64.tar.gz"
    end
    on_arm do
      sha256 "50847dc29c3aee77d5dc559c1a46099aad83491682621382db2ce1a0283e6d79"
